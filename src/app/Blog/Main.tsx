...
export default function Main() {
    const posts = [
      {
        ...
        date: "Feb 14, 2022",
        image: {IM1}, // Replace with your image paths
    ...
    const recentPosts = [
      { title: "Post 1", image: {IM1} }, // Replace with actual image paths
    ...
    return (
      <div className="flex bg-gray-100 min-h-screen p-6">
        ...
        <div className="w-1/4 bg-white shadow-md p-6 rounded-lg">
          ...
          <div className="mb-6">
            <Image
              src={PIMG} // Replace with your profile image path
              alt="Prince Miyako"
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <a href="#" className="text-gray-500 hover:text-orange-500">
                <i className="fab fa-twitter"></i> {/* Replace with FontAwesome or similar */}
              </a>
              <a href="#" className="text-gray-500 hover:text-orange-500">
